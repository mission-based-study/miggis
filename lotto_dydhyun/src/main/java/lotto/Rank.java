...
public enum Rank {
    ...
    SECOND(5,false, "5개 일치, 보너스 불 일치 (30,000,000원) - ", 30_000_000), // 보너스 불일치
    THIRD(5, true, "5개 일치, (1,500,000원) - ", 1_500_000),
    ...
    public static Rank findRank(int matchCount, int matchingBonus) {
